...
public class CCampoFactura {
  ...
  public String totalServExonerado;
  
  public String totalMercExonerada;
  
  public String otrosCargos;
  
  public String totalExonerado;
  
  public String totalIVADevuelto;
  ...
  public String omitirReceptor;
  
  public String receptorNombre;
  
  public String receptorTipoIdentif;
  
  public String receptorNumIdentif;
  
  public String receptorProvincia;
  
  public String receptorCanton;
  
  public String receptorDistrito;
  
  public String receptorBarrio;
  
  public String receptorOtrasSenas;
  
  public String receptorCodPaisTel;
  
  public String receptorTel;
  
  public String receptorCodPaisFax;
  
  public String receptorFax;
  ...
  public String totalMercGravadas;
  
  public String totalMercExentas;
  
  public String totalGravados;
  ...
  public String infoRefeTipoDoc;
  
  public String infoRefeNumero;
  
  public String infoRefeFechaEmision;
  
  public String infoRefeCodigo;
  
  public String infoRefeRazon;
  ...
  public String getReceptorNumIdentif() {
    return this.receptorNumIdentif;
  }
  
  public void setReceptorNumIdentif(String receptorNumIdentif) {
  ...
  public String getTotalVentasNeta() {
    return this.totalVentasNeta;
  }
  
  public void setTotalVentasNeta(String totalVentasNeta) {
  ...
  public String getInfoRefeTipoDoc() {
    return this.infoRefeTipoDoc;
  }
  
  public void setInfoRefeTipoDoc(String infoRefeTipoDoc) {
    this.infoRefeTipoDoc = infoRefeTipoDoc;
  }
  
  public String getInfoRefeNumero() {
    return this.infoRefeNumero;
  }
  
  public void setInfoRefeNumero(String infoRefeNumero) {
    this.infoRefeNumero = infoRefeNumero;
  }
  
  public String getInfoRefeFechaEmision() {
    return this.infoRefeFechaEmision;
  }
  
  public void setInfoRefeFechaEmision(String infoRefeFechaEmision) {
    this.infoRefeFechaEmision = infoRefeFechaEmision;
  }
  
  public String getInfoRefeCodigo() {
    return this.infoRefeCodigo;
  }
  
  public void setInfoRefeCodigo(String infoRefeCodigo) {
    this.infoRefeCodigo = infoRefeCodigo;
  }
  
  public String getInfoRefeRazon() {
    return this.infoRefeRazon;
  }
  
  public void setInfoRefeRazon(String infoRefeRazon) {
    this.infoRefeRazon = infoRefeRazon;
  }
